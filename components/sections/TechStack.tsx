  ...
  const techCategories = [
    {
      ...
      technologies: ['PHP (Wordpress & Laravel)', 'Python', 'MySQL', 'Github Action & Workflows', 'Cloudflare CDN'],
      icon: (
    ...
    {
      category: 'Frontend',
      technologies: ['HTML', 'CSS Framework', 'JavaScript', 'jQuery', 'Livewire', 'Filament', 'ReactJS','PreactJs for Wordpress'],
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      technologies: ['GitHub', 'Postman', 'Figma',  'Zapier', 'Klaviyo', 'Orange Data Mining', 'R Studio', 'Monday', 'Clockify'],
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
